...
const people = ["Eliza Thompson", "Logan Smith", "Jenny Kim", "Shane Curtis"]
</script>
		...
		<div class="[ relative ] [ flex flex-col lg:flex-row items-center ]">
			...
			<div class="decorative-group [ absolute top-[5%] md:top-6 lg:top-[20%] lg:right-0 ]">
				...
				<div class="popup-menu-decorative">
					<div class="[ max-w-24 md:max-w-32 lg:max-w-48 ] [ shadow-lg bg-neutral-100/70 ]">
						<img src="/images/popup-menu.png" alt="" class="[ w-full h-auto ]">
					</div>
				</div>
			</div>
		</div>

		<div class="[ mt-auto py-6 ] [ flex flex-col items-center justify-end gap-8 ] [ text-center ]">
			<div>
...
.contacts-decorative {
	@apply p-3 md:p-5 border opacity-55;
